...
SECRET_KEY = 'django-insecure-%f^igks4h2cs+c@y3mxehn7&no_i6ao2m)*qk*9kxk@ors*9__'
...
INSTALLED_APPS = [
    ...
    'django_filters',
    'rest_framework_swagger',# swagger stuff
    # 'social_media'
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')], #swagger stuff
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# save media files in media directory in our app 
MEDIA_ROOT = '/media/'
